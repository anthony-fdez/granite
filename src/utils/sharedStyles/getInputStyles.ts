...
import { IVariants } from "../types/IVariants";
...
const getInputStyles = ({
  ...
  const common: SerializedStyles = css({
    ...
    ".Granite-Input-label": {},
    ".Granite-Input-helperText": {
      flexWrap: "wrap",
      fontSize: 12,
      color: getColor({}).fontDimmed,
    },
    ".Granite-Input-errorText": {
      fontSize: 12,
      color: styles.colors?.red?.[6],
      marginTop: 5,
    },

    ".Granite-Input-inputWrapper": {
      position: "relative",
      ".Granite-Input-iconLeft": {
        position: "absolute",
        top: "50%",
        left: 0,
